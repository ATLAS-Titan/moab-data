...
#-  hist-wait-times-dormant-bin3.py ~~
#
#   This program visualizes the distribution of wait times for bin 3 jobs on
...
def analyze(connection):
    ...
    pyplot.title('Wait Times for Bin 3 Jobs During "Dormant Period"')
    pyplot.grid(True)
