...
#-  hist-wait-times-dormant-all.py ~~
#
#   This program visualizes the distribution of wait times for all jobs on
...
def analyze(connection):
    ...
    pyplot.title('Wait Times for All Jobs During "Dormant Period"')
    pyplot.grid(True)
