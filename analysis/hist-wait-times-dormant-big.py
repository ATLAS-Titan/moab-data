...
#-  hist-wait-times-dormant-big.py ~~
#
#   This program visualizes the distribution of wait times for "big" jobs on
#   Titan during the "dormant period" from July 21 to August 4, when CSC108
#   wasn't running any ATLAS jobs. I define "big" here as including bins 1 and
#   2.
#
...
def analyze(connection):
    ...
    pyplot.title('Wait Times for "Big" Jobs During "Dormant Period"')
    pyplot.grid(True)
