...
#
#   This program visualizes the distribution of wait times for "small" jobs on
#   Titan during the "dormant period" from July 21 to August 4, when CSC108
#   wasn't running any ATLAS jobs. I define "big" here as including bins 3, 4,
#   and 5.
#
...
def analyze(connection):
    ...
    pyplot.title('Wait Times for "Small" Jobs During "Dormant Period"')
    pyplot.grid(True)
