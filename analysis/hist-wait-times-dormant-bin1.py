...
#-  hist-wait-times-dormant-bin1.py ~~
#
#   This program visualizes the distribution of wait times for bin 1 jobs on
...
def analyze(connection):
    ...
    pyplot.title('Wait Times for Bin 1 Jobs During "Dormant Period"')
    pyplot.grid(True)
