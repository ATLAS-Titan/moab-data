...
#   jobs submitted by non-CSC108 projects during the two weeks prior to the
#   "dormant" period from July 21 through August 4, when CSC108 was not running
#   ATLAS jobs, versus the wait times experienced during the dormant period
#   itself.
#
...
def analyze(connection):
  ...
  # Create the QQ plot.
    ...
    ax.set(xlabel = "Pre-Dormant (July 7 - 21)",
        ...
        title = "QQ Plot: Wait Times for All Bins for Fixed Time Periods")
    ax.grid()
