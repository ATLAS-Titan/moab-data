...
#-  hist-wait-times-dormant-bin5.py ~~
#
#   This program visualizes the distribution of wait times for bin 5 jobs on
...
def analyze(connection):
    ...
    pyplot.title('Wait Times for Bin 5 Jobs During "Dormant Period"')
    pyplot.grid(True)
