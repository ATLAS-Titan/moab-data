...
#   bin 4 jobs submitted by non-CSC108 projects, with and without CSC108
#   running active jobs in backfill.
#
#   Bin 4 jobs use between 126 and 312 nodes, inclusive.
#
...
def analyze(connection):
  ...
  # WaitTime for bin 4 jobs submitted by projects other than CSC108, when
    ...
    query = """
        SELECT DISTINCT
            ...
            WHERE
                ...
                AND (126 <= B.ReqNodes AND B.ReqNodes <= 312)
    ...
    query = """
        ...
        SELECT DISTINCT JobID,
            ...
            WHERE
                ...
                AND (126 <= ReqNodes AND ReqNodes <= 312)
  ...
  # Create the QQ plot.
    ...
    ax.set(xlabel = "With CSC108 Running", ylabel = "Without CSC108 Running",
        title = "QQ Plot: Wait Times for Bin 4 Jobs")
    ax.grid()
