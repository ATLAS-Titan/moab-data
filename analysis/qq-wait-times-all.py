...
#   jobs submitted by non-CSC108 projects, with and without CSC108 running
#   active jobs in backfill.
#
...
def analyze(connection):
  ...
  # WaitTime for jobs submitted by projects other than CSC108, when CSC108 is
  # running jobs in backfill. It checks to make sure that the various
  ...
  # Create the QQ plot.
    ...
    ax.set(xlabel = "With CSC108 Running", ylabel = "Without CSC108 Running",
        title = "QQ Plot: Wait Times for All Bins")
    ax.grid()
