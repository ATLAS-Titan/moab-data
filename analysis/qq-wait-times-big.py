...
#   "big" jobs submitted by non-CSC108 projects, with and without CSC108
#   running active jobs in backfill.
#
#   Here, I have defined "big" as including bin 1 and bin 2 jobs, which means
#   that any job using 3750 nodes or more is considered "big" in this program.
#
...
def analyze(connection):
  ...
  # WaitTime for "big" jobs submitted by projects other than CSC108, when
  ...
  # Create the QQ plot.
    ...
    ax.set(xlabel = "With CSC108 Running", ylabel = "Without CSC108 Running",
        title = "QQ Plot: Wait Times for Big Jobs")
    ax.grid()
