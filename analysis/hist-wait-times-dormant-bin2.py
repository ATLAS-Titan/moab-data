...
#-  hist-wait-times-dormant-bin2.py ~~
#
#   This program visualizes the distribution of wait times for bin 2 jobs on
...
def analyze(connection):
    ...
    pyplot.title('Wait Times for Bin 2 Jobs During "Dormant Period"')
    pyplot.grid(True)
