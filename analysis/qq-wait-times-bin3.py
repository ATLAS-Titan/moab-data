...
#   bin 3 jobs submitted by non-CSC108 projects, with and without CSC108
#   running active jobs in backfill.
#
#   Bin 3 jobs use between 313 and 3749 nodes, inclusive.
#
...
def analyze(connection):
  ...
  # WaitTime for bin 3 jobs submitted by projects other than CSC108, when
    ...
    query = """
        SELECT DISTINCT
            ...
            WHERE
                ...
                AND (313 <= B.ReqNodes AND B.ReqNodes <= 3749)
    ...
    query = """
        ...
        SELECT DISTINCT JobID,
            ...
            WHERE
                ...
                AND (313 <= ReqNodes AND ReqNodes <= 3749)
  ...
  # Create the QQ plot.
    ...
    ax.set(xlabel = "With CSC108 Running", ylabel = "Without CSC108 Running",
        title = "QQ Plot: Wait Times for Bin 3 Jobs")
    ax.grid()
