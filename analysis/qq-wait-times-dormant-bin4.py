...
#   bin 4 jobs submitted by non-CSC108 projects during the two weeks prior to
...
def analyze(connection):
  ...
  # Create the QQ plot.
    ...
    ax.set(xlabel = "Pre-Dormant (July 7 - 21)",
        ...
        title = "QQ Plot: Wait Times for Bin 4 Jobs for Fixed Time Periods")
    ax.grid()
